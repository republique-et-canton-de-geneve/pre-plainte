...
class Ech051BuilderTest {
  ...
  @Test
  void generateEch051Xml_shouldFormatActionPeriodWithEuropeZurichOffset() {
    PrePlainte prePlainte = mock(PrePlainte.class);
    ...
    assertThat(xml)
        .contains("<eCH-0051:actionPeriodFrom>2026-01-12T10:15:00.000+01:00</eCH-0051:actionPeriodFrom>")
        .contains("<eCH-0051:actionPeriodTo>2026-07-12T11:45:00.000+02:00</eCH-0051:actionPeriodTo>");
  }

  @Test
  void generateEch051Xml_shouldTreatNaiveActionPeriodAsEuropeZurichLocalTime() {
    PrePlainte prePlainte = mock(PrePlainte.class);
    Ech0051DocumentPayload.Event event = Ech0051DocumentPayload.Event.builder()
        .key("EVT-NAIVE")
        .actionPeriod(Ech0051DocumentPayload.ActionPeriod.builder()
            .from("2026-06-04T14:00")
            .to("2026-06-04T16:30")
            .build())
        .build();
    Ech0051DocumentPayload payload = Ech0051DocumentPayload.builder()
        .processData(Ech0051DocumentPayload.ProcessData.builder().deliveryDate("2026-06-04").sourceId(Ech051Constants.SourceIds.VOL).processingStatus("GREEN").build())
        .events(List.of(event))
        .relations(Ech0051DocumentPayload.Relations.builder().build())
        .build();
  ...
  void generateEch051Xml_shouldMapProcessDataSourceIdWithSepSourceTableAndAelNumber() {
    ...
    assertThat(xml)
        .contains("<eCH-0051:sourceID source=\"SEP\" sourceTable=\"Pré-plainte en ligne\">AEL-PPL-V-2QVTL32C8E</eCH-0051:sourceID>");
  }
