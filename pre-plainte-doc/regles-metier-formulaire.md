...
| Lieu d'origine | Validation des champs | Selon le cas | Obligatoire si la nationalite indiquee est suisse. | nationalite suisse sans lieu d'origine est refusee<br><br>nationalite suisse avec lieu d'origine est acceptee<br><br>nationalite non suisse sans lieu d'origine est acceptee |
...
| Adresse de l'evenement | Validation des champs | Oui | L'adresse connue et le type de lieu doivent etre renseignes quand l'adresse n'est pas celle du lese. | adresse connue absente est refusee<br><br>type de lieu absent est refuse |

## Vol

| Champ demande | Type de regle | Obligatoire | Precision | Exemples testes |
| --- | --- | --- | --- | --- |
| Informations de base de l'objet vole | Validation des champs | Oui | Un vol doit indiquer si l'objet etait dans un vehicule, la categorie de l'objet et l'existence de degradations. | indication vol dans vehicule absente est refusee<br><br>categorie d'objet absente est refusee<br><br>information sur les degradations absente est refusee |
...
| Numero IMEI | Validation des champs | Selon le cas | Obligatoire et compose de 15 chiffres pour un telephone mobile sauf si le numero est inconnu, auquel cas une justification est requise. | telephone mobile sans IMEI est refuse<br><br>IMEI avec moins de 15 chiffres est refuse<br><br>IMEI de 15 chiffres est accepte<br><br>IMEI inconnu sans justification est refuse<br><br>IMEI inconnu avec justification est accepte |
...
| Service propose | Blocage | Oui | Les services proposes dependent du type d'incident et doivent avoir au moins un creneau disponible. | incident vol conserve uniquement le service vol<br><br>incident dommage conserve uniquement le service dommage<br><br>incident cyber conserve uniquement le service cyber-escroquerie |
