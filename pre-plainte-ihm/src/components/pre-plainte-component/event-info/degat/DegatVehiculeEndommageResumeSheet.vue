<template>
  <div>
    <v-sheet class="pa-4 mb-4 objet-degrade-resume">
      ...
      <v-row dense>
        <v-col v-if="obj.categorieObjet" cols="12" md="6">
        ...
        <v-col v-if="obj.modele || obj.modeleAutre" cols="12" md="6">
        ...
        <v-col v-if="obj.sousCategorie === 'velos' && obj.numeroCadre" cols="12" md="6">
